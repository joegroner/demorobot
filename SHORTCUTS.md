...
DemoRobot uses the [Ace](https://ace.c9.io/) as editor component for the *Configuration* view. Ace comes with a
...
DemoRobot as expected. Additionally you can use *Ctrl+s / Command+s* to save your current configuration on every screen.
